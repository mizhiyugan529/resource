...
function yetlj() {
	...
	input.value = input.value+ '<img src="链接（后缀通常情况应为png或jpg等）" />'; // 修改输入框的值
	input.dispatchEvent(event) // 手动触发输入框的input事件
	$("#yeloubqb").removeClass("active");
	$("#yebqb").attr("hidden","hidden");}
function yejsjbz() {
