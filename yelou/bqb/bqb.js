...
$(document).ready(function () {
    ...
    $(".am-tabs-nav.am-nav.am-nav-tabs").prepend("<li id='yeloubqb' class><a href='#yelou'>忧郁小猫猫</li>");
    $("#yeclj").on("click", function () {
        $("#wenbenkuang").val($("#wenbenkuang").val() + '<a href="链接" target="_blank">点我就看XXX</a>');
    });
    $("#yejsjbz").on("click", function () {
        $("#wenbenkuang").val($("#wenbenkuang").val() + '<font class="xiu">文字</font>');
    });
    $("#yezyb").on("click", function () {
        $("#wenbenkuang").val($("#wenbenkuang").val() + '<font class="zheyingbu">文字</font>');
    });
    $("#yeloubqb").on("click", function() {
      ...
      $("#yejsjbz").on("click", function() {
        $("#wenbenkuang").val(
          $("#wenbenkuang").val() + '<font class="xiu">文字</font>'
        );
        $(".am-tabs-bd").hide();
      });
      $("#yezyb").on("click", function() {
        $("#wenbenkuang").val(
          $("#wenbenkuang").val() + '<font class="zheyingbu">文字</font>'
        );
        $(".am-tabs-bd").hide();
      });
      $("#yejgg").on("click", function() {
        $("#wenbenkuang").val(
          $("#wenbenkuang").val() +
            '<scri'+'pt>ye_call_board="文字或链接/图片代码"</sc'+'ript>'
        );
        $(".am-tabs-bd").hide();
      });
      $("#yebwz").on("click", function() {
        $("#wenbenkuang").val($("#wenbenkuang").val() +'<b>文字</b>');
        $(".am-tabs-bd").hide();
      });
      $("#yehwz").on("click", function() {
        $("#wenbenkuang").val($("#wenbenkuang").val() +'<font color=red><b>文字</b></font>');
        $(".am-tabs-bd").hide();
      });
      $(".am-tabs-bd").show();
    });
